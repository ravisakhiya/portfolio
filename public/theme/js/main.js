...
(function($) {
    ...
    function verificationForm() {
        ...
        function step2() {
            form.validate({
                ...
                messages: {
                    ...
                    budget: {
                        required: "Please Enter Valid budget.",
                        minlength: "Too short."
                    }
                }
            });
        ...
        $(".slide.one button.next").click(function() {
            step1();
            if (form.valid() === true) {
                if (animating) return false;
                animating = true;
        ...
        $(".slide.two button.next").click(function() {
            form2 = $("#msform");
            form2.valid() = false;
            step2();
            if (form2.valid() === true) {
        ...
        $(".slide.three button.finish-btn").click(function() {
            step3();
            if (form3.valid() === true) {
                if (animating) return false;
                animating = true;
